...
(function (global) {
  const T = {
    fr: {
      ...
      'journal-text': 'Lavé en pierre pour révéler sa matière vivante. Notre édition limitée célèbre une filière courte et un savoir-faire retrouvé, pensé pour traverser les saisons.',
      ...
      'cart-message-note': 'Les photos partent en pièces jointes (pas en liens). Sur téléphone, choisissez Messages ou WhatsApp.',
      ...
      'cart-message-tiktok-hint': 'Choisissez TikTok dans Partager, ou collez le message dans un DM.',
      'cart-message-no-phone': 'Numéro du vendeur non configuré — ouvrez Admin → Contact pour l’ajouter.',
      'cart-message-no-tiktok': 'Compte TikTok non configuré — ouvrez Admin → Contact.',
      'cart-message-error': 'Impossible d’envoyer le panier. Réessayez.',
      'cart-message-preparing': 'Préparation des photos…',
      'cart-message-share-sms-hint': 'Choisissez Messages pour envoyer les photos.',
      'cart-message-share-wa-hint': 'Choisissez WhatsApp pour envoyer texte + photos.',
      'cart-message-share-fallback': 'Impossible de joindre les photos automatiquement.',
      'cart-message-share-need-phone': 'Utilisez un téléphone (Safari / Chrome) pour envoyer les photos.',
      'cart-message-no-images': 'Aucune photo à joindre — message texte copié.',
      'cart-message-attach-title': 'Envoyer avec les photos',
      'cart-message-attach-hint': 'Les images ci-dessous seront jointes. Appuyez sur Partager, puis Messages ou WhatsApp.',
      'cart-message-attach-share': 'Partager photos + texte',
      'cart-message-attach-download': 'Télécharger les photos',
      'cart-message-downloaded': 'Photos téléchargées et texte copié — joignez-les dans le message.',
      ...
      'login-footer-html': 'Pas encore de compte ? <a href="/compte/?page=signup">Créer un compte</a>',
      ...
      'link-have-account-html': 'Déjà un compte ? <a href="/login/">Se connecter</a>',
      ...
      'empty-saved-html': 'Aucun article sauvegardé. <a href="/#boutique" style="color:var(--charcoal)">Parcourir la boutique</a>',
      ...
      'admin-contact-title': 'Contact panier (WhatsApp / SMS / TikTok)',
      'admin-contact-settings': 'Paramètres de contact',
      'admin-contact-back': '← Retour',
      'admin-contact-note': 'Les clients envoient leur panier ici. Indiquez le numéro avec l’indicatif pays, sans + ni espaces (ex. 33612345678).',
      'admin-contact-phone': 'Téléphone (SMS)',
      'admin-contact-whatsapp': 'WhatsApp (si différent)',
      'admin-contact-tiktok': 'TikTok (sans le @)',
      'admin-contact-save': 'Enregistrer le contact',
      'admin-contact-saved': 'Contact enregistré.',
      ...
      'admin-ai-placeholder': 'Joignez une image avec + et décrivez (ex. « change this product »)…',
    ...
    en: {
      ...
      'journal-text': 'Stone-washed to reveal its living texture. Our limited edition celebrates a short supply chain and rediscovered craft, designed to last through the seasons.',
      ...
      'cart-message-note': 'Photos are sent as attachments (not links). On your phone, pick Messages or WhatsApp.',
      'cart-message-whatsapp': 'WhatsApp',
      'cart-message-sms': 'SMS',
      'cart-message-tiktok': 'TikTok',
      'cart-message-copy': 'Copy message',
      'cart-message-copied': 'Message copied.',
      'cart-message-tiktok-hint': 'Pick TikTok in Share, or paste the message into a DM.',
      'cart-message-no-phone': 'Seller phone not set — add it in Admin → Contact.',
      'cart-message-no-tiktok': 'TikTok account not set — add it in Admin → Contact.',
      'cart-message-error': 'Could not send the cart. Please try again.',
      'cart-message-preparing': 'Preparing photos…',
      'cart-message-share-sms-hint': 'Choose Messages to send the photos.',
      'cart-message-share-wa-hint': 'Choose WhatsApp to send text + photos.',
      'cart-message-share-fallback': 'Could not attach photos automatically.',
      'cart-message-share-need-phone': 'Use a phone (Safari / Chrome) to send the photos.',
      'cart-message-no-images': 'No photos to attach — text message copied.',
      'cart-message-attach-title': 'Send with photos',
      'cart-message-attach-hint': 'The images below will be attached. Tap Share, then Messages or WhatsApp.',
      'cart-message-attach-share': 'Share photos + text',
      'cart-message-attach-download': 'Download photos',
      'cart-message-downloaded': 'Photos downloaded and text copied — attach them in your message.',
      ...
      'login-footer-html': 'No account yet? <a href="/compte/?page=signup">Create an account</a>',
      ...
      'link-have-account-html': 'Already have an account? <a href="/login/">Sign in</a>',
      ...
      'empty-saved-html': 'No saved items. <a href="/#boutique" style="color:var(--charcoal)">Browse the shop</a>',
      'admin-sidebar': 'MD3 Admin',
      ...
      'admin-contact-title': 'Cart contact (WhatsApp / SMS / TikTok)',
      'admin-contact-settings': 'Contact settings',
      'admin-contact-back': '← Back',
      'admin-contact-note': 'Customers send their cart here. Use country code, digits only, no + or spaces (e.g. 33612345678).',
      'admin-contact-phone': 'Phone (SMS)',
      'admin-contact-whatsapp': 'WhatsApp (if different)',
      'admin-contact-tiktok': 'TikTok (without @)',
      ...
      'admin-ai-placeholder': 'Attach an image with + and describe (e.g. “change this product”)…',
    ...
    ar: {
      ...
      'journal-text': 'يُغسل بالحجر لإبراز ملمسه الحي. يحتفي إصدارنا المحدود بسلسلة توريد قصيرة وحرفة متجددة، مصممة لتعبر المواسم.',
      ...
      'cart-message-note': 'تُرسل الصور كمرفقات (وليس روابط). على الهاتف اختاري الرسائل أو واتساب.',
      ...
      'cart-message-tiktok-hint': 'اختاري تيك توك من المشاركة، أو الصقي الرسالة في DM.',
      'cart-message-no-phone': 'رقم البائعة غير مضبوط — أضيفيه في Admin → Contact.',
      'cart-message-no-tiktok': 'حساب تيك توك غير مضبوط — أضيفيه في Admin → Contact.',
      'cart-message-error': 'تعذر إرسال السلة. حاولي مجدداً.',
      'cart-message-preparing': 'جاري تجهيز الصور…',
      'cart-message-share-sms-hint': 'اختاري الرسائل لإرسال الصور.',
      'cart-message-share-wa-hint': 'اختاري واتساب لإرسال النص مع الصور.',
      'cart-message-share-fallback': 'تعذر إرفاق الصور تلقائياً.',
      'cart-message-share-need-phone': 'استخدمي هاتفاً (Safari / Chrome) لإرسال الصور.',
      'cart-message-no-images': 'لا توجد صور للإرفاق — تم نسخ النص.',
      'cart-message-attach-title': 'إرسال مع الصور',
      'cart-message-attach-hint': 'الصور أدناه ستُرفق. اضغطي مشاركة ثم الرسائل أو واتساب.',
      'cart-message-attach-share': 'مشاركة الصور والنص',
      'cart-message-attach-download': 'تنزيل الصور',
      'cart-message-downloaded': 'تم تنزيل الصور ونسخ النص — أرفقيها في الرسالة.',
      ...
      'login-footer-html': 'ليس لديك حساب؟ <a href="/compte/?page=signup">إنشاء حساب</a>',
      ...
      'link-have-account-html': 'لديك حساب بالفعل؟ <a href="/login/">تسجيل الدخول</a>',
      ...
      'empty-saved-html': 'لا توجد مقالات محفوظة. <a href="/#boutique" style="color:var(--charcoal)">تصفح المتجر</a>',
      'admin-sidebar': 'MD3 Admin',
      ...
      'admin-contact-title': 'جهة اتصال السلة (واتساب / SMS / تيك توك)',
      'admin-contact-settings': 'إعدادات الاتصال',
      'admin-contact-back': '← رجوع',
      'admin-contact-note': 'العملاء يرسلون سلتهم هنا. استخدمي رمز الدولة وأرقاماً فقط بدون + أو مسافات (مثل 33612345678).',
      'admin-contact-phone': 'الهاتف (SMS)',
      'admin-contact-whatsapp': 'واتساب (إن اختلف)',
      'admin-contact-tiktok': 'تيك توك (بدون @)',
      'admin-contact-save': 'حفظ جهة الاتصال',
      'admin-contact-saved': 'تم حفظ جهة الاتصال.',
