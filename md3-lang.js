...
(function (global) {
  const T = {
    fr: {
      ...
      'cart-message-no-phone': 'Numéro du vendeur non configuré — ouvrez Admin → Contact pour l’ajouter. WhatsApp s’ouvre quand même.',
      'cart-message-no-tiktok': 'Compte TikTok non configuré — ouvrez Admin → Contact. Messages TikTok s’ouvrent quand même.',
    ...
    en: {
      ...
      'cart-message-no-phone': 'Seller phone not set — add it in Admin → Contact. WhatsApp still opens.',
      'cart-message-no-tiktok': 'TikTok account not set — add it in Admin → Contact. Messages still open.',
    ...
    ar: {
      ...
      'cart-message-no-phone': 'رقم البائعة غير مضبوط — أضيفيه في Admin → Contact. سيفتح واتساب رغم ذلك.',
